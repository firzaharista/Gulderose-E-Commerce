<?php 
      ...
      class Product extends CI_Controller 
      {
            ...
            public function allproducts()
            {
                  ...
                  if ($jumlah > 0) {
                        $params["product_data"] = $this->Produk_model->get_current_page_records($limit_per_page, $page*$limit_per_page);
                        ...
                        // $config['query_string_segment'] = 'total-product';
                        ...
                        // mengambil uri segment ke-3
                        // $from = $this->uri->segment(3);
                        $this->pagination->initialize($config);
                        /* eksekusi library pagination ke model penampilan data */
                        // $this->data['product_data'] = $this->Produk_model->get_all_product($config['per_page'], $from);
                        // build paging links
                  ...
                  $this->load->view('front/product/product-body', $params);
            }
