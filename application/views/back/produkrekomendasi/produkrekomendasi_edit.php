                        ...
                        <div class="card">
                              ...
                              <div class="body">
                                    ...
                                    <div class="row clearfix">
                                          ...
                                          <div class="col-lg-10">
                                                <?php echo form_dropdown('', $get_combo_produk, $produk_rekomendasi->id_produk, $produk_id); ?>
                                          </div>
                                    </div>
                                    <br>
                                    <div class="row clearfix">
                                    ...
                                    <?php echo form_input($id_produkrekomendasi, $produk_rekomendasi->id_produkrekomendasi) ?>
                                    <?php form_close() ?>
                              </div>
