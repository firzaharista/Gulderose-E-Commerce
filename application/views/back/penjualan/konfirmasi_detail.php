                        ...
                        <div class="card" id="details">
                            <div class="body">
                                <div class="row">
                                    <div class="col-md-7 col-sm-7">
                                        <address>
                                            ...
                                            <p class="m-b-0"><strong>Bank Pengirim : </strong><?php echo $konf_data->nama_bankasal ?></p>
                                        </address>
                                    </div>
                                ...
                                <div class="hidden-print col-md-12 text-right">
                                    <a href="<?php echo base_url('admin_gulderose/penjualan/sudah-konfirmasi') ?>"><button class="btn btn-warning btn-round"><i class="zmdi zmdi-rotate-left"></i> Kembali</button></a>
                                    <a href="<?php echo base_url('admin_gulderose/penjualan/update_sudah_konfirmasi/') . $konfirmasi_detail->id_trans; ?>"><button class="btn btn-info btn-round"><i class="zmdi zmdi-check"></i> Konfirmasi</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
