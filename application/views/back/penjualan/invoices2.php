    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong></strong> Invoice Gulderose</h2>
                    ...
                    <div class="body">
                        <h3 class="m-b-0">Invoice Details : <strong class="text-primary">#GDR0001</strong></h3>
                        <ul class="nav nav-tabs">
                            ...
                            <div class="body">                                
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <address>
                                            <strong>Firza Affan Harista</strong><br>
                                            Weleri, Kendal<br>
                                            Jawa Tengah 51355<br>
                                            <abbr title="Phone"></abbr> 081888112211
                                        </address>
                                    </div>
                                    <div class="col-md-6 col-sm-6 text-right">
                                        <p class="m-b-0"><strong>Tanggal Order: </strong> 1 Juni 2019</p>
                                        <p class="m-b-0"><strong>Status Order: </strong> <span class="badge bg-orange">Process</span></p>
                                        <p><strong>Order ID: </strong> #GRD0001</p>
                                    </div>
                                </div>
                                <div class="mt-40"></div>
                                <div class="row">
                                            ...
                                            <table class="table table-hover table-responsive">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th></th>
                                                        <th class="hidden-sm-down">Deskripsi</th>
                                                        <th>Jumlah Produk</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td><img src="assets/images/ecommerce/17.jpg" width="50" alt="Product img"></td>
                                                        <td>Gulderose Wall Decor</td>
                                                        <td class="hidden-sm-down">Ukuran S (25 cm x 35 cm)</td>
                                                        <td align="center">3</td>
                                                        <td class="hidden-sm-down">Rp. 35.000</td>
                                                        <td>Rp. 105.000</td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
                                                        <td><img src="assets/images/ecommerce/18.jpg" width="50" alt="Product img"></td>
                                                        <td>Gulderose Flower Bouquet</td>
                                                        <td class="hidden-sm-down">Ukuran M (40 cm x  60 cm)</td>
                                                        <td align="center">1</td>
                                                        <td class="hidden-sm-down">Rp. 70.000</td>
                                                        <td>Rp. 70.000</td>
                                                    </tr>
                                                    <tr>
                                                        <td>3</td>
                                                        <td><img src="assets/images/ecommerce/19.jpg" width="50" alt="Product img"></td>
                                                        <td>Gulderose Flower Bouquet</td>
                                                        <td class="hidden-sm-down">Ukuran M (40 cm x 60 cm)</td>
                                                        <td align="center">1</td>
                                                        <td class="hidden-sm-down">Rp. 75.000</td>
                                                        <td>Rp. 75.000</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5>Catatan</h5>
                                        <p>Apabila sudah konfirmasi pembayaran, tidak perlu konfirmasi lagi</p>
                                    </div>
                                    <div class="col-md-6 text-right">
                                        <p class="m-b-0"><b>Sub-total: </b>  Rp. 280.000</p>
                                        <p class="m-b-0">Diskon: 10%</p>
                                        <!-- <p class="m-b-0">VAT: 12.9%</p>                                         -->
                                        <h3 class="m-b-0 m-t-10">Rp. 252.000</h3>
                                    </div>
                                </div>
                                <hr>
                                <div class="hidden-print col-md-12 text-right">
                                    <button class="btn btn-warning btn-icon  btn-icon-mini btn-round"><i class="zmdi zmdi-print"></i></button>
                                    <button class="btn btn-primary btn-round">Cetak</button>
                                </div>
                            </div>
                        </div>
                    </div>
