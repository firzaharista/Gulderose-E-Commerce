            ...
            <div class="row">
                  ...
                  <div class="col-lg-7 col-md-7 col-sm-12 text-right">
                        ...
                        <ul class="breadcrumb float-md-right">
                              ...
                              <li class="breadcrumb-item"><a href="<?php echo base_url('admin_gulderose/subkategori'); ?>">SubKategori</a></li>
            ...
            <div class="row clearfix">
                  <div class="col-lg-12 col-md-12">
                        <div class="card">
                              <div class="header">
                                    <h2>
                                          <strong>Edit</strong> SubKategori
                                          <small>Untuk mengubah data SubKategori</small>
                                    </h2>
                                    <ul class="header-dropdown">
                                          <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                      <li><a href="<?php echo base_url('admin_gulderose/subkategori') ?>">Data SubKategori</a></li>
                                                </ul>
                                          </li>
                                          <li class="remove">
                              ...
                              <div class="body">
                                    ...
                                    <div class="row clearfix">
                                          ...
                                          <div class="col-lg-10 col-md-10 col-sm-8">
                                                <?php echo form_dropdown('', $ambil_kategori, $subkategori->id_kategori, $kat_id); ?>
                                          </div>
                                    </div>
                                    <br>
                                    <div class="row clearfix">
                                    ...
                                    <?php echo form_input($id_subkategori, $subkategori->id_subkategori); ?>
                                    <?php echo form_close() ?>
