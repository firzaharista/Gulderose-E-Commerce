                              ...
                              <div class="body">
                                    ...
                                    <div class="row clearfix">
                                          ...
                                          <div class="col-lg-10 col-md-10 col-sm-8">
                                                <div class="form-group has-success">
                                                      <?php echo form_input($produk_upd, $produk->judul_produk) ?>
                                                </div>
                                          </div>
                                    </div>
                                    ...
                                    <div class="row clearfix">
                                          ...
                                          <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group has-success">
                                                      <?php echo form_input($harga_normal, $produk->harga_normal) ?>
                                          ...
                                          <div class="col-lg-5 col-md-4 col-sm-4">
                                                <div class="form-group has-success">
                                                      <?php echo form_input($diskon, $produk->diskon) ?>
                                    ...
                                    <div class="row clearfix">
                                          <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                                <label for="stok">Stok <b><?php echo '(' . $produk->stok . ')' ?></b></label>
                                          </div>
                                          <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group">
                                                      <select name="stok" id="stok" class="form-control show-tick" required='required'>
                                                            <option value="">-- Pilih Stok --</option>
                                                            <?php
                                                            $data = array('tersedia', 'kosong');
                                                            if ($data[0] == $produk->stok) { ?>
                                          ...
                                          <div class="col-lg-5 col-md-4 col-sm-4">
                                                <div class="form-group has-success">
                                                      <?php echo form_input($harga_diskon, $produk->harga_diskon) ?>
                                    ...
                                    <div class="row clearfix">
                                          ...
                                          <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group has-success">
                                                      <?php echo form_input($berat, $produk->berat) ?>
                                                </div>
                                          </div>
                                          <div class="col-lg-1 col-md-2 col-sm-4 form-control-label">
                                                <label for="ukuran">Ukuran <b><?php echo '( ' . ucwords($produk->ukuran) . ' )' ?></b></label>
                                          </div>
                                          <div class="col-lg-5">
                                                <select name="ukuran" id="ukuran" class="form-control show-tick" required=''>
                                                      <option value="">-- Pilih Ukuran --</option>
                                                      <?php
                                                      $data = array('s','m','big');
                                                      if ($data[0] == $produk->ukuran) { ?>
                                                            <option value="s" selected>S</option>
                                                            <option value="m">M</option>
                                                            <option value="big">BIG</option>
                                                      <?php } elseif ($data[1] == $produk->ukuran) { ?>
                                                            <option value="s">S</option>
                                                            <option value="m" selected>M</option>
                                                            <option value="big">BIG</option>
                                                      <?php } elseif($data[2] == $produk->ukuran) { ?>
                                                            <option value="s">S</option>
                                                            <option value="m">M</option>
                                    ...
                                    <div class="row clearfix">
                                          ...
                                          <div class="col-lg-10 col-md-4 col-sm-4">
                                                <?php echo form_dropdown('', $ambil_kategori, $produk->id_kategori, $kat_id); ?>
                                          </div>
                                    </div> <br>
                                    <div class="row clearfix">
                                          <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                          ...
                                          <div class="col-lg-10 col-md-4 col-sm-4" id='subkat_id'>
                                                <?php echo form_dropdown('', $ambil_subkat, $produk->id_subkategori, $subkat_id) ?>
                                          </div>
                                    </div> <br>
                                    <div class="row clearfix">
                                          <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                                <label for="gambar_sebelum">Gambar Sebelumnya</label>
                                          </div>
                                          <div class="col-lg-10 col-md-10 col-sm-8">
                                                <img src="<?php echo base_url('assets/images/produk/' . $produk->foto . $produk->foto_type . '') ?>" width='250px' alt="foto">
                                          </div>
                                    </div>
                                    <br>
                                    <div class="row clearfix">
