                              ...
                              <div class="body">
                                    ...
                                    <div class="row clearfix">
                                          <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                                <label for="produk_created">Nama Produk</label>
                                          </div>
                                          <div class="col-lg-10 col-md-10 col-sm-8">
                                                <div class="form-group has-success">
                                                      <?php echo form_input($produk_created) ?>
                                                </div>
                                          </div>
                                    </div>
                                    ...
                                    <div class="row clearfix">
                                          ...
                                          <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group">
                                                      <select name="stok" id="stok" class="form-control show-tick">
                                    ...
                                    <div class="row clearfix">
                                          ...
                                          <div class="col-lg-5">
                                                <select name="ukuran" id="ukuran" class="form-control show-tick" required='required'>
                                    ...
                                    <div class="row clearfix">
                                          ...
                                          <div class="col-lg-10 col-md-10 col-sm-8">
                                                <div class="form-group has-success">
                                                      <input type="file" class="form-control form-control-success" required="required" name="foto" id="foto" onchange="tampilkanPreview(this,'preview')" />
                                                </div>
                                          </div>
                                    </div>
                                    <div class="row clearfix">
