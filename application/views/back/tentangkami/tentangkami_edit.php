            ...
            <div class="row">
                  ...
                  <div class="col-lg-7 col-md-7 col-sm-12 text-right">
                        ...
                        <ul class="breadcrumb float-md-right">
                              ...
                              <li class="breadcrumb-item"><a href="<?php echo base_url('admin_gulderose/terms_of_service'); ?>"><?php echo $modul ?></a></li>
                  ...
                  <div class="col-lg-12 col-md-12">
                        <div class="card">
                              ...
                              <div class="body">
                                    ...
                                    <!-- CKEditor -->
                                    <?php echo form_textarea($isi_tentangkami, $tentangkami->isi_tentangkami); ?>
                                    <!-- #END# CKEditor -->
                              </div>
                              <div class="row clearfix">
                              ...
                              <?php echo form_input($id_tentangkami, $tentangkami->id_tentangkami) ?>
