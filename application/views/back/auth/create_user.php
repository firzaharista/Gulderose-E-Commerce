    ...
    <div class="row">
      ...
      <div class="col-lg-7 col-md-7 col-sm-12 text-right">
        ...
        <ul class="breadcrumb float-md-right">
          ...
          <li class="breadcrumb-item"><a href="<?php echo base_url('admin_gulderose/auth'); ?>"><?php echo $modul ?></a></li>
    ...
    <div class="row clearfix">
      <div class="col-lg-12 col-md-12">
        <div class="card">
          ...
          <div class="body">
            <!-- <form action='create_user' class="form-horizontal" id="form_advanced_validation" method="POST" enctype="multipart/form-data"> -->
            ...
            <div class="row clearfix">
              ...
              <div class="col-lg-5 col-md-4 col-sm-4">
                <?php echo form_dropdown('', $get_all_users_group, '', $id_group); ?>
              </div>
            </div>
            <div class="row clearfix">
              <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
            ...
            <div class="row clearfix">
              ...
              <div class="col-lg-5 col-md-4 col-sm-4" id='kota_id'>
                <?php echo form_dropdown('', array('' => 'Pilih Provinsi Dulu'), '', $kota_id); ?>
              </div>
            </div>
            <div class="row clearfix">
              <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
