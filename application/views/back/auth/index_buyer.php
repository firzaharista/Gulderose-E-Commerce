    ...
    <div class="row clearfix">
      <div class="col-lg-12">
        <div class="card">
          <div class="header">
            <h2>
              <strong>Data</strong> <?php echo $modul ?> Buyer
          ...
          <div class="body">
            <div class="table-responsive">
              ...
              <a href="<?php echo base_url('admin_gulderose/auth/users_superadmin') ?>"><button class="btn btn-info btn-round">Superadmin</button></a>
