            ...
            <div class="row clearfix">
                  <div class="col-lg-12 col-md-12">
                        <div class="card">
                              <div class="header">
                                    <h2>
                                          <strong>Edit</strong> Slider
                                          <small>Untuk mengubah data slider</small>
                                    </h2>
                              ...
                              <div class="body">
                                    ...
                                    <div class="row clearfix">
                                          ...
                                          <div class="col-lg-10 col-md-10 col-sm-8">
                                                <img src="<?php echo base_url('assets/images/slider/' . $slider->foto . $slider->foto_type . '') ?>" width='250px' alt="foto">
                                          </div>
                                    </div>
                                    <br>
                                    <div class="row clearfix">
