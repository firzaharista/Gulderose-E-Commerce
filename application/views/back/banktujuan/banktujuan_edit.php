            ...
            <div class="row clearfix">
                  <div class="col-lg-12 col-md-12">
                        <div class="card">
                                    ...
                                    <ul class="header-dropdown">
                                          <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                      <li><a href="<?php echo base_url('admin_gulderose/banktujuan') ?>">Data <?php echo $modul ?></a></li>
                                                </ul>
                                          </li>
                                          <li class="remove">
                              ...
                              <div class="body">
                                    ...
                                    <div class="row clearfix">
                                          <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                                <label for="nama_banktujuan">Nama <?php echo $modul ?></label>
                                          </div>
                                          <div class="col-lg-10 col-md-10 col-sm-8">
                                                <div class="form-group has-success">
                                                      <?php echo form_input($nama_banktujuan, $bank_tujuan->nama_banktujuan) ?>
                                                </div>
                                          </div>
                                    </div>
                                    <div class="row clearfix">
                                          <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                                <label for="no_rektujuan">No. Rekening</label>
                                          </div>
                                          <div class="col-lg-10 col-md-10 col-sm-8">
                                                <div class="form-group has-success">
                                                      <?php echo form_input($no_rektujuan, $bank_tujuan->no_rektujuan) ?>
                                                </div>
                                          </div>
                                    </div>
                                    <div class="row clearfix">
                                          <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                                <label for="atas_namatujuan">Atas Nama</label>
                                          </div>
                                          <div class="col-lg-10 col-md-10 col-sm-8">
                                                <div class="form-group has-success">
                                                      <?php echo form_input($atas_namatujuan, $bank_tujuan->atas_namatujuan) ?>
                                                </div>
                                          </div>
                                    </div>
                                    <div class="row clearfix">
                              ...
                              <?php echo form_input($id_banktujuan, $bank_tujuan->id_banktujuan) ?>
