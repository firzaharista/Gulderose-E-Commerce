            ...
            <div class="row clearfix">
                  <div class="col-lg-12 col-md-12">
                        <div class="card">
                              ...
                              <div class="body">
                                    ...
                                    <div class="row clearfix">
                                          <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                                <label for="nama_bankasal">Nama <?php echo $modul ?></label>
                                          </div>
                                          <div class="col-lg-10 col-md-10 col-sm-8">
                                                <div class="form-group has-success">
                                                      <?php echo form_input($nama_bankasal, $bank_asal->nama_bankasal) ?>
                                                </div>
                                          </div>
                                    </div>
                                    <div class="row clearfix">
                              ...
                              <?php echo form_input($id_bankasal, $bank_asal->id_bankasal) ?>
