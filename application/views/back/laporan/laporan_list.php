                                          ...
                                          <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                      <div class="input-group">
                                                            ...
                                                            <input type="date" id='tgl_awal' name='tgl_awal' class="form-control" placeholder="Ex: 2016-02-15">
                                                      </div>
                                                </div>
                                          </div>
                                          <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                      <div class="input-group">
                                                            <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i> </span>
                                                            <input type="date" id='tgl_akhir' name='tgl_akhir' class="form-control" placeholder="Ex: 2016-03-15">
                                                      </div>
                                                </div>
                                          </div>
                                          <div class="row clearfix">
                                    ...
                                    <div class="row clearfix">
                                          ...
                                          <div class="col-lg-10 col-md-10 col-sm-8">
                                                <div class="input-group">
                                                      ...
                                                      <select name="judul_produk" id="judul_produk" class="form-control show-tick">
                                                            <option value="">- Pilih Produk -</option>
                                                            <?php
                                                            foreach ($get_perproduk as $row) {
