...
header("content-disposition: attachment;filename=Laporan_Penjualan_Gulderose_Per_Produk.xls");
            ...
            <table class="table table-hover table-bordered table-striped table-responsive">
                  <tbody>
                        <tr>
                              ...
                              <th scope="row">
                                    <h4><b><?php echo 'Rp. ' . number_format($total_penjualan_per_produk->subtotal, 2, ',', '.'); ?></b></h4>
                              </th>
                        </tr>
                  </tbody>
            </table>
