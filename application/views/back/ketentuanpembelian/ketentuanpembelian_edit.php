            ...
            <div class="row">
                  ...
                  <div class="col-lg-8 col-md-8 col-sm-12 text-right">
                        ...
                        <ul class="breadcrumb float-md-right">
                              ...
                              <li class="breadcrumb-item"><a href="<?php echo base_url('admin_gulderose/ketentuanpembelian'); ?>"><?php echo $modul ?></a></li>
                  ...
                  <div class="col-lg-12 col-md-12">
                        <div class="card">
                              ...
                              <div class="body">
                                    ...
                                    <?php echo form_textarea($isi_ketentuan, $ketentuan->isi_ketentuan) ?>
                                    <!-- <textarea id="ckeditor" name='isi_ketentuan'>
