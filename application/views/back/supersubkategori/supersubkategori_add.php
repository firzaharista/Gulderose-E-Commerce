                  ...
                  <div class="col-lg-12 col-md-12">
                        <div class="card">
                              ...
                              <div class="body">
                                    ...
                                    <div class="row clearfix">
                                          <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                                <label for="judul_subkategori">Judul SubKategori</label>
                                          </div>
                                          <div class="col-lg-10 col-md-10 col-sm-8" id="subkat_id">
                                    ...
                                    <div class="row clearfix">
                                          <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                                                <label for="judul_supersubkategori">Judul <?php echo $modul ?></label>
                                          </div>
                                          <div class="col-lg-10 col-md-10 col-sm-8">
...
<script type="text/javascript">
      function tampilSubkat() {
            ...
            $.ajax({
                  url: "<?php echo base_url(); ?>admin_gulderose/supersubkategori/pilih_subkategori/" + kat_id + "",
