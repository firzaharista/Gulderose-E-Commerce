                              ...
                              <div class="page-login box space-50">
                                    <div class="row">
                                          <div class="col-md-6 col-md-offset-3 sign-in space-30">
                                                ...
                                                <p>Already have an account? Please Sign In <b><a href="<?php echo base_url('auth/login'); ?>">here</a> </b></p>
                                                <?php echo $message; ?>
                                                <?php echo form_open_multipart("create-account"); ?>
                                                ...
                                                <div class="group box space-20">
                                                      ...
                                                      <?php echo form_dropdown('', $ambil_kota, '', $kota_id); ?>
                                                </div>
                                                <div class="group box space-20">
