                  ...
                  <div class="row">
                        <div class="col-md-10 sign-in space-30">
                              <div class="box">
                                    ...
                                    <p>Welcome Back, <?php echo $profil->nama; ?></p>
                                    <!-- End social -->
                                    <form class="form-horizontal" method="POST">
                                          <div class="group box space-5">
                                                <label class="control-label" for="inputemail">Account *</label>
                                                <p> <i class="far fa-user"></i> <?php echo $profil->nama; ?>
                                                      <br> <i class="far fa-envelope"></i> Email : <?php echo $profil->email; ?>
                                                      <br> <i class="fa fa-phone"></i> Phone : <?php if ($this->session->userdata('phone') == NULL) {
                                                                                                            echo '<b>Belum di isi</b>';
                                                                                                      } else {
                                                                                                            echo $profil->phone;
                                                                                                      } ?>
                                                      <br> <i class="fa fa-map-marker "></i> Address : <?php if ($profil->address == '') {
                                                                                                            echo '<b>Belum di isi</b>';
                                                                                                      } else {
                                                                                                            echo $profil->address . ', ' . $profil->nama_kota . ', ' . $profil->nama_provinsi;
                                                                                                      } ?>
                                                      <br>
                                                      <br> Last Login : <?php if (!empty($profil->last_login)) {
                                                                                                            echo date("d-m-Y, H:i:s", $profil->last_login) . ' WIB';
                                                                                                      } else {
                                                ...
                                                <tbody>
                                                      <?php $start = 1;
                                                            ...
                                                            <tr>
                                                                  ...
                                                                  <td style="text-align:center"><?php echo date("d-m-Y, H:i", strtotime($history->waktu_trans)) . ' WIB'; ?></td>
                                                                  ...
                                                                  <td style="text-align:center">
                                                                        ...
                                                                        <?php } elseif ($history->status == '2') { ?>
                                                                              <button type="button" name="status" class="btn btn-success">Confirmation Success</button>
                                                                        <?php } elseif ($history->status == '3') { ?>
                                                                              <button type="button" name="status" class="btn btn-primary">Payment Accepted and Processing</button>
